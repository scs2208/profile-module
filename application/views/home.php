...
<li class="nav-item">
<a class="nav-link" href="<?php echo base_url('index.php/CTRL_Registration/displaydata'); ?>">Contact</a>
</li>
</ul>
</div>
</nav>
...
integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/J
mZQ5stwEULTy" crossorigin="anonymous"></script>
